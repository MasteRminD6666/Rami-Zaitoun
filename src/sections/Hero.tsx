  ...
  return (
    <section className="relative flex min-h-screen w-full flex-col">
      <div className="c-space mx-auto mt-20 flex w-full flex-col gap-3 sm:mt-36">
        <p className="text-center font-generalsans text-xl font-medium text-white sm:text-3xl ml-5">
          Rami Zaitoun is fighting for the people behind the pixels. <span className="waving-hand">🪖</span>
        </p>
