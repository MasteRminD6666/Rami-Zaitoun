...
- [Stats](#wrench-stats)
- [Community](#raised_hands-community)
...
You might encounter some bugs while using this app. You are more than welcome to share improvements. Just submit changes via pull request and I will review them before merging. Make sure you follow community guidelines.
...
You're encouraged to share feedback on [Netlify's GitHub repository](https://github.com/netlify/netlify).
